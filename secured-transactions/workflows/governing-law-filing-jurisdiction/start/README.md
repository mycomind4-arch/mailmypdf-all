# Governing Law & Filing Jurisdiction Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Governing Law & Filing Jurisdiction; it should use the shared workspace shell rather than public marketing UI.

# UCC-1 Preparation & Authorization Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for UCC-1 Preparation & Authorization; it should use the shared workspace shell rather than public marketing UI.

# UCC-1 Preparation & Authorization Official Forms

## Purpose

Stores authoritative blank forms for UCC-1 Preparation & Authorization only when a real issuing/filing authority provides them.

# UCC-1 Preparation & Authorization Rules

## Purpose

Contains deterministic rules unique to UCC-1 Preparation & Authorization. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

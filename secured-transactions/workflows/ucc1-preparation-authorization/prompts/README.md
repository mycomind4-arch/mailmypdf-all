# UCC-1 Preparation & Authorization Prompts

## Purpose

Contains narrowly scoped AI prompts for UCC-1 Preparation & Authorization; deterministic legal/filing rules must remain in rules or shared engines.

# Priority Strategy Rules

## Purpose

Contains deterministic rules unique to Priority Strategy. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

# Name & Capacity Resolution Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Name & Capacity Resolution; it should use the shared workspace shell rather than public marketing UI.

# Name & Capacity Resolution Rules

## Purpose

Contains deterministic rules unique to Name & Capacity Resolution. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

# Name & Capacity Resolution Prompts

## Purpose

Contains narrowly scoped AI prompts for Name & Capacity Resolution; deterministic legal/filing rules must remain in rules or shared engines.

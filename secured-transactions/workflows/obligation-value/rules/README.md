# Obligation & Value Rules

## Purpose

Contains deterministic rules unique to Obligation & Value. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

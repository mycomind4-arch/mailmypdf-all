# Obligation & Value Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Obligation & Value; it should use the shared workspace shell rather than public marketing UI.

# Obligation & Value Prompts

## Purpose

Contains narrowly scoped AI prompts for Obligation & Value; deterministic legal/filing rules must remain in rules or shared engines.

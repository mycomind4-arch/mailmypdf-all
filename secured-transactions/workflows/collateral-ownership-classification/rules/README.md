# Collateral Ownership & Classification Rules

## Purpose

Contains deterministic rules unique to Collateral Ownership & Classification. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

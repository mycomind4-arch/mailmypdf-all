# Collateral Ownership & Classification Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Collateral Ownership & Classification; it should use the shared workspace shell rather than public marketing UI.

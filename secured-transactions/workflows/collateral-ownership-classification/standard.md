# Collateral Ownership & Classification — Workflow Standard

Updated: 2026-09-17

## Purpose

Identify proposed collateral, determine what evidence supports rights in it, and classify the collateral for later rule analysis.

## Planned primary output

Collateral inventory, ownership findings, classification findings, and description candidates.

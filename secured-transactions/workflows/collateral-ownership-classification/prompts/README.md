# Collateral Ownership & Classification Prompts

## Purpose

Contains narrowly scoped AI prompts for Collateral Ownership & Classification; deterministic legal/filing rules must remain in rules or shared engines.

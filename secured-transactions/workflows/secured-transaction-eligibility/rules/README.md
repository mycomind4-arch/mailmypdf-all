# Secured-Transaction Eligibility Rules

## Purpose

Contains deterministic rules unique to Secured-Transaction Eligibility. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

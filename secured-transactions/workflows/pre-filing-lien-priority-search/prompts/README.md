# Pre-Filing Lien & Priority Search Prompts

## Purpose

Contains narrowly scoped AI prompts for Pre-Filing Lien & Priority Search; deterministic legal/filing rules must remain in rules or shared engines.

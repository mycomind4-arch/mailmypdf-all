# Pre-Filing Lien & Priority Search Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Pre-Filing Lien & Priority Search; it should use the shared workspace shell rather than public marketing UI.

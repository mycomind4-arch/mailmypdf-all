# Perfection Method Selection Rules

## Purpose

Contains deterministic rules unique to Perfection Method Selection. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

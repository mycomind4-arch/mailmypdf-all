# Perfection Method Selection Prompts

## Purpose

Contains narrowly scoped AI prompts for Perfection Method Selection; deterministic legal/filing rules must remain in rules or shared engines.

# Perfection Method Selection Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Perfection Method Selection; it should use the shared workspace shell rather than public marketing UI.

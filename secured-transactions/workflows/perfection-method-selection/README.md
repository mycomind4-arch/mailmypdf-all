# Perfection Method Selection — Workflow Plan

## Purpose

Select the lawful perfection method for each collateral class, including filing, possession, control, title notation, or another supported method.
...
Primary planned outputs: perfection plan, method-by-collateral matrix, required actions, and exception findings. This workflow must expose uncertainty and provenance rather than allowing AI to silently select a legally consequential answer.

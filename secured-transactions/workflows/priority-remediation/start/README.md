# Priority Remediation Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Priority Remediation; it should use the shared workspace shell rather than public marketing UI.

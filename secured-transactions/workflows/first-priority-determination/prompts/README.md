# First-Priority Determination Prompts

## Purpose

Contains narrowly scoped AI prompts for First-Priority Determination; deterministic legal/filing rules must remain in rules or shared engines.

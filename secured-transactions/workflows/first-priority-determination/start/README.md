# First-Priority Determination Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for First-Priority Determination; it should use the shared workspace shell rather than public marketing UI.

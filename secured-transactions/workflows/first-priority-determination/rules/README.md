# First-Priority Determination Rules

## Purpose

Contains deterministic rules unique to First-Priority Determination. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

# Security Agreement Generation Rules

## Purpose

Contains deterministic rules unique to Security Agreement Generation. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

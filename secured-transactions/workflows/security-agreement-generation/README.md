# Security Agreement Generation — Workflow Plan

## Purpose

Assemble an authenticated security agreement from verified parties, obligation facts, authority, and a sufficiently specific collateral description.
...
Primary planned outputs: draft security agreement, source map, validation report, and execution requirements. This workflow must expose uncertainty and provenance rather than allowing AI to silently select a legally consequential answer.

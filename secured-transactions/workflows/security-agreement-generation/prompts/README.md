# Security Agreement Generation Prompts

## Purpose

Contains narrowly scoped AI prompts for Security Agreement Generation; deterministic legal/filing rules must remain in rules or shared engines.

# Security Agreement Generation Authority

## Purpose

Maps Security Agreement Generation rules and findings to authoritative sources and records jurisdiction coverage.

# Security Agreement Generation Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Security Agreement Generation; it should use the shared workspace shell rather than public marketing UI.

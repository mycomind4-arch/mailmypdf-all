# Perfection Execution Rules

## Purpose

Contains deterministic rules unique to Perfection Execution. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

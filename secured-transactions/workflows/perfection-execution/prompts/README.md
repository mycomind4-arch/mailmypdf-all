# Perfection Execution Prompts

## Purpose

Contains narrowly scoped AI prompts for Perfection Execution; deterministic legal/filing rules must remain in rules or shared engines.

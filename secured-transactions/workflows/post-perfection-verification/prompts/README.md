# Post-Perfection Verification Prompts

## Purpose

Contains narrowly scoped AI prompts for Post-Perfection Verification; deterministic legal/filing rules must remain in rules or shared engines.

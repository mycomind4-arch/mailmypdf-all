# Post-Perfection Verification Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Post-Perfection Verification; it should use the shared workspace shell rather than public marketing UI.

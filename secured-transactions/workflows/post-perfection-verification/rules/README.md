# Post-Perfection Verification Rules

## Purpose

Contains deterministic rules unique to Post-Perfection Verification. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

# Attachment Certification Rules

## Purpose

Contains deterministic rules unique to Attachment Certification. Shared Article 9 engines and jurisdiction rules must be imported rather than copied.

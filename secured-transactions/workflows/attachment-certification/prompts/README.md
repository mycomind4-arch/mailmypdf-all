# Attachment Certification Prompts

## Purpose

Contains narrowly scoped AI prompts for Attachment Certification; deterministic legal/filing rules must remain in rules or shared engines.

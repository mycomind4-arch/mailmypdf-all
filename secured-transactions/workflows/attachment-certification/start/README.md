# Attachment Certification Authenticated Start

## Purpose

Authenticated entry surface and runtime binding for Attachment Certification; it should use the shared workspace shell rather than public marketing UI.

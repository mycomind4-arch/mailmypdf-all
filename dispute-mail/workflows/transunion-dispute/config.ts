...
export const workflowConfig = {
  ...
  primaryCtaLabel: "Start TransUnion Dispute",
  secondaryCtaLabel: "See how it works",
  overview: "If you find information on your TransUnion credit report that you believe is inaccurate or incomplete, you can dispute it with the credit reporting company. The CFPB recommends identifying each error clearly, explaining why it is wrong, requesting the correction you want, and including copies of supporting documents. This workflow organizes those pieces into a reviewable mailed dispute packet.",
  whatYouDo: [
    "Work from the TransUnion credit report that contains the information you want to dispute.",
  ...
  whatYouNeed: [
    "The TransUnion credit report showing the item or items you want to dispute",
  ...
  workflowSteps: [
    ["Review the TransUnion report", "Start from the report containing the disputed information and identify the specific items you want addressed."],
  ...
  readyItems: [
    ["TransUnion credit report", "Use the report that actually contains the information you are disputing."],
  ...
  sources: [
    ...
    { title: "TransUnion credit dispute information", publisher: "TransUnion", href: "https://www.transunion.com/credit-disputes/dispute-your-credit" },
  ],
  relatedWorkflows: [
    { title: "Equifax Dispute", path: "/dispute-mail/workflows/equifax-dispute", description: "Use this workflow for inaccurate or incomplete information on an Equifax credit report." },

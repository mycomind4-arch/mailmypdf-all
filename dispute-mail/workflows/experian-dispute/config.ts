...
export const workflowConfig = {
  ...
  whatYouDo: [
    "Work from the Experian credit report that contains the information you want to dispute.",
  ...
  whatYouNeed: [
    "The Experian credit report showing the item or items you want to dispute",
  ...
  workflowSteps: [
    ["Review the Experian report", "Start from the report containing the disputed information and identify the specific items you want addressed."],
  ...
  readyItems: [
    ["Experian credit report", "Use the report that actually contains the information you are disputing."],
  ...
  sources: [
    ...
    { title: "Experian credit dispute information", publisher: "Experian", href: "https://www.experian.com/help/dispute-credit/" },
  ],
  relatedWorkflows: [

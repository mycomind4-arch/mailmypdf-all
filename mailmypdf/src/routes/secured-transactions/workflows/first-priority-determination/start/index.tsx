// Thin file-route mount for the top-level secured-transactions/workflows/first-priority-determination/start/ implementation.
...
export const Route = createFileRoute("/secured-transactions/workflows/first-priority-determination/start/")({
  component: () => (

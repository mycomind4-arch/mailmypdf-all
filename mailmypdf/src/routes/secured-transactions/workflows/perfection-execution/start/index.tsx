// Thin file-route mount for the top-level secured-transactions/workflows/perfection-execution/start/ implementation.
...
export const Route = createFileRoute("/secured-transactions/workflows/perfection-execution/start/")({
  component: () => (

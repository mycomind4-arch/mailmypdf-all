...
const categories = [
  ...
  ["Legal Defense", "Arrests, searches, evidence, counsel packets"],
...
function EcosystemPage() {
  ...
  const total = authorityPages.length;

import { assertRecipient, materializeApprovedPacket } from "./case-approval.server";
...
export async function createOrLoadOrder(input: {
  caseId: string;
  approvalId: string;
...
export async function ensureCheckoutSession(input: {
  order: {
    id: string;
    lookup_token: string;

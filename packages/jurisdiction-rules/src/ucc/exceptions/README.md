# UCC Exceptions Rules

## Purpose

Versioned jurisdiction-specific exceptions rules for UCC workflows.

## Planned files

| Future file or directory | Function |
| --- | --- |
| `rules.ts` | Explicitly supported statutory or jurisdictional exceptions. |
| `exception-registry.json` | Exception IDs, applicability, jurisdiction, dates, and authority links. |
| `types.ts` | Exception result types. |

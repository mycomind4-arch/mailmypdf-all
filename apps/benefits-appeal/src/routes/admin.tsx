...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [
      { title: "Admin — Benefits Appeal" },
      { name: "description", content: "Administrative dashboard for Benefits Appeal." },
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-2xl font-bold text-ink" style={{ fontFamily: "var(--font-serif)" }}>Benefits Appeal — System Health</h1>
            </div>
          </div>
          <p className="mt-3 text-sm text-muted-foreground">

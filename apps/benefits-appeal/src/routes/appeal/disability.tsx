...
const category = categoryMap["disability"];
const entries = APPEAL_CATALOG.filter((e) => e.category === category);

export const Route = createFileRoute("/appeal/disability")({
  head: () => ({
    meta: [
      { title: "Disability & Social Security Appeals | Benefits Appeal" },
      { name: "description", content: "SSDI, SSI, and Social Security appeals from initial denial through reconsideration, hearing, and Appeals Council." },
      { name: "robots", content: "index,follow" },
      { property: "og:title", content: "Disability & Social Security Appeals | Benefits Appeal" },
      { property: "og:description", content: "SSDI, SSI, and Social Security appeals from initial denial through reconsideration, hearing, and Appeals Council." },
  ...
  component: () => (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <h1 className="mt-3 font-serif text-4xl">Disability & Social Security Appeals</h1>
        <p className="mt-4 max-w-2xl text-lg text-muted-foreground">SSDI, SSI, and Social Security appeals from initial denial through reconsideration, hearing, and Appeals Council.</p>

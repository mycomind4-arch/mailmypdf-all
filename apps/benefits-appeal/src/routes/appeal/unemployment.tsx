...
const category = categoryMap["unemployment"];
const entries = APPEAL_CATALOG.filter((e) => e.category === category);

export const Route = createFileRoute("/appeal/unemployment")({
  head: () => ({
    meta: [
      { title: "Unemployment Benefit Appeals | Benefits Appeal" },
      { name: "description", content: "Unemployment insurance denials, EDD determinations, and work separation disputes." },
      { name: "robots", content: "index,follow" },
      { property: "og:title", content: "Unemployment Benefit Appeals | Benefits Appeal" },
      { property: "og:description", content: "Unemployment insurance denials, EDD determinations, and work separation disputes." },
  ...
  component: () => (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <h1 className="mt-3 font-serif text-4xl">Unemployment Benefit Appeals</h1>
        <p className="mt-4 max-w-2xl text-lg text-muted-foreground">Unemployment insurance denials, EDD determinations, and work separation disputes.</p>

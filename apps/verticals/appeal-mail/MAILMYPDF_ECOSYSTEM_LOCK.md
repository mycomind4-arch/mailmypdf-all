...
Do not create a separate global navigation, auth model, sitemap strategy, canonical domain, pricing calculator, or pipeline for an Appeal Mail workflow when the shared architecture applies. Vertical-specific intelligence and pricing profiles belong here; shared engines belong in `this monorepo's shared packages`.

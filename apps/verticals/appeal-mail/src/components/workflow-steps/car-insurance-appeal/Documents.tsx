...
const RECOMMENDED_CATEGORIES = [
  ...
  "Police Report",
  "Repair Estimate / Appraisal",
  "Photos of Damage",
  "Correspondence with Adjuster",
  "Witness Statements",
];
  ...
  return (
    <>
      <SectionCard
        ...
        description="Upload the claim denial letter, your policy declarations page, the police report, repair estimate or appraisal, and photos of the damage. These documents will be used to verify the denial and included in your mailing package as exhibits."
      ...
      <RecommendedStepsRow
        steps={[{ label: "Upload the denial letter" }, { label: "Add repair estimate and photos" }, { label: "Continue to Analyze" }]}

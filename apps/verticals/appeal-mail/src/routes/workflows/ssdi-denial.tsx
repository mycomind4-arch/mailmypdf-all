...
import {
  ...
  WorkflowFAQSection,
  RelatedWorkflowsSection,
  getFAQSchema,
} from "@/components/workflow/workflow-landing-section";
  ...
  head: () => ({
    meta: [
      { title: "Appeal an SSDI Denial — Appeal Mail" },
      {
        name: "description",
        content:
          "Upload your SSDI denial notice, understand the findings, build a reconsideration or hearing request, and send it by certified mail to the SSA.",
      },
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 3,
              name: "SSDI Denial",
              item: "/workflows/ssdi-denial",
            },
          ],
        }),
      },
      ...(getFAQSchema(WORKFLOW_ID)
        ? [
            {
              type: "application/ld+json",
              children: JSON.stringify(getFAQSchema(WORKFLOW_ID)),
            },
          ]
        : []),
    ],

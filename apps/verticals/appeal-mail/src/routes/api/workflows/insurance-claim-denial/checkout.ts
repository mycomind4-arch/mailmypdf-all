          ...
          const session = await stripe.checkout.sessions.create({
            ...
            line_items: [{
              price_data: {
                currency: "usd",
                product_data: {
                  name: "Insurance Claim Denial Appeal Packet",
            ...
            metadata: {
              appeal_id: a.id,
              workflow_id: "insurance-claim-denial",
            ...
            success_url: `${appUrl}/workflows/insurance-claim-denial?checkout=success&session_id=${encodeURIComponent("{CHECKOUT_SESSION_ID}")}`,

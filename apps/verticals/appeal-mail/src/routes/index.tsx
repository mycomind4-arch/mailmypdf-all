...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "Appeal Mail — Understand the Decision. Build the Appeal. Mail It.",
      },
      {
        name: "description",
        content:
          "Understand adverse decisions, organize evidence, build supported appeals, and mail them with proof of delivery. A MailMyPDF product.",
      },
      ...
      },
      {
        ...
        content:
          "Analyze decisions, organize evidence, build supported appeals, and send with proof of delivery. A MailMyPDF product.",
      },
      ...
      { property: "og:url", content: SITE_ORIGIN + "/" },
      {
        property: "og:image",
        content:
          "https://media.base44.com/images/public/6a8bd310dfdf9ad92cf26415/a99daa8e1_generated_image.png",
      },
      ...
      },
      {
        ...
        content:
          "Analyze decisions, organize evidence, build supported appeals, and send with proof of delivery.",
      },
      {
        name: "twitter:image",
        content:
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Appeal Mail",
          description:
            "Specialized workflows for understanding adverse decisions, organizing evidence, and building supported appeals with proof of delivery.",
          url: SITE_ORIGIN,
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Upload a denial or decision letter. The system analyzes it, identifies issues, organizes evidence, drafts the response, and mails it with proof of delivery.",
...
const trustItems = [
  {
    icon: ShieldCheck,
    title: "User review before sending",
    desc: "Nothing is mailed until you review and approve it.",
  },
  {
    icon: Eye,
    title: "Source-aware reasoning",
    desc: "Findings cite the exact document and passage they come from.",
  },
  {
    icon: AlertTriangle,
    title: "No fabricated facts",
    desc: "The AI never invents facts, legal conclusions, or evidence.",
  },
  {
    icon: Mail,
    title: "No automatic mailing",
    desc: "Physical mail is never sent without your explicit authorization.",
  },
];
...
const faqItems = [
  {
    ...
    a: "No. Appeal Mail is a correspondence tool, not a law firm. We help you prepare and send appeal documents — we do not provide legal advice.",
  },
  {
    q: "What types of decisions can I appeal?",
    a: "Insurance claim denials, health insurance decisions, SSI and SSDI denials, unemployment determinations, Medicaid denials, licensing and DMV decisions, and more. Browse the full directory on the Workflows page.",
  },
  {
    q: "How does the mailing work?",
    a: "Your final document is printed, placed in an envelope, and mailed via USPS by MailMyPDF. You can choose first-class, certified, or certified with return receipt for proof of delivery.",
  },
  {
    q: "Is my data secure?",
  ...
  {
    q: "What does it cost?",
    a: "Mailing starts at $4.99 standard (includes printing, paper, envelope, and postage). Certified is $14.94. The final packet total is shown before payment. No subscription required.",
  },
  {
    q: "Do I need a MailMyPDF account?",
    a: "Yes. A free MailMyPDF Account lets you save your work, track mailings, and keep proof of delivery. One account works across all MailMyPDF products.",
  },
];
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 50%, color-mix(in oklab, var(--stamp) 5%, transparent) 0%, transparent 70%)",
        }}
      />
      <div
        className="rounded-2xl border border-rule bg-card p-6 md:p-8"
      ...
      >
        ...
        <div className="flex flex-col gap-1 md:flex-row md:items-start md:gap-0">
          {lifecycleSteps.map((step, i) => (
            <div
              key={step.label}
              className="flex items-center gap-2 md:flex-1 md:flex-col md:items-center md:text-center"
            >
              {/* Node */}
              <div className="relative flex flex-shrink-0 items-center justify-center">
                <div
                  ...
                  style={{
                    ...
                    background:
                      i === 0
                        ? "color-mix(in oklab, var(--stamp) 8%, transparent)"
                        : "var(--paper-deep)",
                  }}
                >
                  <step.icon
        ...
        <div className="mt-6 border-t border-rule pt-4">
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span className="font-mono uppercase tracking-widest">
              You approve before anything is mailed
            </span>
          </div>
        </div>
      </div>
...
function FeaturedWorkflowCard({
  ...
  const isExecutable =
    ...
    entry.executable &&
    entry.slug === "ssdi-denial";

  return (
    <Link
      to={entry.route}
      className="card group block p-5 transition-all hover:shadow-[var(--shadow-hover)] hover:-translate-y-0.5"
    >
      ...
      <h3
        className="text-base font-semibold text-ink transition-colors group-hover:text-stamp"
    ...
    <main>
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url(https://media.base44.com/images/public/6a8bd310dfdf9ad92cf26415/a99daa8e1_generated_image.png)",
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(26,29,41,0.94) 0%, rgba(26,29,41,0.80) 45%, rgba(26,29,41,0.72) 100%)",
          }}
        />
        <div className="container relative py-24 md:py-32">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="max-w-xl">
              <span
                className="postmark mb-6"
                style={{
                  borderColor: "rgba(180,83,9,0.5)",
                  color: "rgba(217,180,120,0.9)",
                }}
              >
              ...
              <p className="mt-6 max-w-lg text-base leading-7 hero-muted sm:text-lg">
                Got a denial, suspension, or government decision you need to
                challenge? Upload the document, let the analysis find the
                issues, build a supported response, and mail it with proof of
                timely filing.
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full border hero-border px-6 py-3 text-sm font-medium hero-light transition-colors hover:bg-white/10"
                >
        ...
        <div className="container">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-ink-soft">
              Every appeal follows the same disciplined progression. You stay in
              control at every step — nothing is mailed until you approve it.
            </p>
          </div>
      ...
      <section className="border-y border-rule bg-card py-20 md:py-28">
        <div className="container">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-ink-soft">
              Each workflow is tailored to a specific type of decision —
              insurance denials, government benefits, DMV suspensions, financial
              aid appeals, and more.
            </p>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container max-w-2xl text-center">
          ...
          <p className="mt-4 text-base text-muted-foreground">
            Find the workflow that matches your situation and upload your
            document.
          </p>

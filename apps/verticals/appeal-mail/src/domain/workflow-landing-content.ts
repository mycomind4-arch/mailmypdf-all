...
export const workflowLandingContent: Partial<Record<string, LandingContent>> = {
  ...
  "car-insurance-appeal": {
    h1: "Appeal a Car Insurance Claim Denial",
    subheadline: "Upload your denial or reduction letter. AI identifies the insurer's liability, damage, or coverage determination, builds a specific evidence-backed appeal, and sends it by certified mail.",
    whatItMeans: "A car insurance claim denial or reduction means your insurer decided you were at fault (in whole or in part), that the damage isn't covered, or that a policy exclusion applies. Insurers are required to give you a specific reason. That reason — and the evidence behind it — can often be challenged, especially when it conflicts with a police report, an independent repair estimate, or your own account of the accident.",
    whoIsThisFor: "Drivers whose auto insurance claim was denied outright, or approved for less than expected — including disputes over who was at fault, how much the damage is worth, whether a total loss valuation is fair, or whether a policy exclusion actually applies.",
    commonReasons: [
      "The insurer found you fully or partially at fault (comparative negligence)",
      "The insurer's damage assessment or repair estimate is lower than your own",
      "A total-loss valuation you believe undervalues your vehicle",
      "A cited policy exclusion or coverage limitation you believe doesn't apply",
      "An excluded driver was behind the wheel, according to the insurer",
      "Missed or disputed filing deadlines",
      "Suspected fraud or misrepresentation allegations",
    ],
    whatMatters: "The most important things are the insurer's exact stated reason for the denial or reduction, the claim and policy numbers, the accident date, and any evidence that contradicts the insurer's position — a police report, an independent repair estimate or appraisal, photos of the damage, witness statements, or dashcam footage. A specific appeal that rebuts the stated reason point by point, with your own evidence attached, is far more effective than a general complaint.",
    evidenceChecklist: [
      "The denial or claim-reduction letter",
      "Your policy declarations page",
      "The police report, if one was filed",
      "An independent repair estimate or appraisal",
      "Photos of the vehicle damage",
      "Any witness statements or dashcam/camera footage",
      "Prior correspondence with the adjuster",
    ],
    deadlineGuidance: "Appeal windows vary by insurer and by state — many give 30 to 60 days from the decision letter, but some are shorter. Your denial letter should state the deadline; if it doesn't, ask your adjuster to confirm it in writing. If the internal appeal doesn't resolve the dispute, you generally have the option to file a complaint with your state's insurance department, or, depending on your policy, invoke an appraisal clause. Certified mail gives you proof your appeal was delivered before the deadline.",
    whatWeDo: "Appeal Mail analyzes your denial letter with AI to identify the claim and policy numbers, the insurer's stated liability, damage, or coverage determination, and the deadline. It drafts a specific appeal that rebuts the insurer's stated reason point by point using your own evidence, validates the letter for completeness before you approve it, and sends it by certified mail with tracking and proof of delivery.",
    ctaText: "Start your car insurance appeal",
    faqs: [
      { question: "How long do I have to appeal a car insurance claim denial?", answer: "It depends on your insurer and your state — many allow 30 to 60 days from the date of the denial or reduction letter, but some windows are shorter. Check your letter for the exact deadline, and if none is stated, ask your adjuster to confirm one in writing." },
      { question: "What's the most common reason auto claims get denied or reduced?", answer: "The most common disputes are over who was at fault (including a comparative-negligence or percentage-at-fault split), how much the damage is worth compared to your own repair estimate, whether a total-loss valuation is fair, and whether a cited policy exclusion actually applies to your situation." },
      { question: "What evidence actually helps an auto insurance appeal?", answer: "A police report, an independent repair estimate or appraisal, photos of the damage, witness statements, and dashcam or other footage are the strongest evidence — especially when any of them conflicts with the insurer's stated liability or damage finding." },
      { question: "Do I need a lawyer to appeal a car insurance denial?", answer: "No. Most auto insurance appeals are handled directly with the insurer's claims department and don't require an attorney. Appeal Mail helps you prepare a specific, evidence-backed appeal letter — but it isn't a law firm and doesn't provide legal advice." },
      { question: "What if my appeal is denied again?", answer: "If the internal appeal doesn't resolve the dispute, you can generally file a complaint with your state's insurance department, and some policies include an appraisal clause for disputed damage valuations. For larger disputes, some drivers pursue legal counsel or small claims court." },
    ],
    relatedWorkflowIds: ["insurance-claim-denial", "claim-denial-letter"],
  },

  "administrative-decision-appeal": {
    h1: "Appeal an Administrative Decision",
    subheadline: "Upload the decision or notice you received. AI identifies the decision-maker, jurisdiction, deadline, and disputed findings, then builds a structured appeal for certified mailing.",
    whatItMeans: "An adverse administrative decision is a written determination from a government agency, licensing board, or other administrative body — a permit denial, a regulatory penalty, a licensing action, or another agency ruling. Most administrative bodies require you to file an internal appeal (sometimes called 'exhausting administrative remedies') before any court will hear the matter, and the window to do so is often short and strictly enforced.",
    whoIsThisFor: "Anyone who received an adverse decision, notice, or order from a government agency, regulatory body, or licensing board and wants to challenge it — including permit and licensing decisions, regulatory penalties, and other administrative rulings that are not already covered by a more specific workflow (insurance, Social Security, unemployment, or financial aid appeals each have their own dedicated workflow).",
    commonReasons: [
      "The agency says you didn't meet a regulatory or licensing requirement",
      "The agency cites a factual finding you dispute",
      "The agency didn't address evidence you submitted",
      "A procedural step was allegedly missed or completed late",
      "The stated basis conflicts with the agency's own prior correspondence",
      "The penalty or outcome is disputed as disproportionate to the finding",
    ],
    whatMatters: "The most important things are: which agency or body issued the decision and under what jurisdiction (state, county, city, or federal), the exact appeal deadline and how it's counted from the decision date, whether you're required to exhaust an internal review step before any outside appeal, and the specific findings the decision relies on versus what is simply assumed or unsupported in the record.",
    evidenceChecklist: [
      "The decision, notice, or order you received",
      "Any appeal or hearing instructions included with the decision",
      "Prior correspondence with the agency or decision-maker",
      "Records, receipts, or documentation relevant to the agency's findings",
      "The specific regulation, statute, or rule the agency cited (if any)",
      "Proof of any earlier internal review or reconsideration request",
    ],
    deadlineGuidance: "Administrative appeal deadlines vary enormously by agency and jurisdiction — some allow as little as 10 to 15 days from the decision date, while others allow 30 to 60 days. The deadline and the correct appeal body are usually stated on the decision notice itself; if they aren't, confirm both in writing before relying on a general rule of thumb. Missing the deadline can permanently forfeit your right to appeal, so certified mail with proof of delivery is strongly recommended for any filing this time-sensitive.",
    whatWeDo: "Appeal Mail analyzes your decision notice with AI to identify the decision-maker, jurisdiction, stated deadline, and the specific findings versus unsupported assumptions. It helps you organize disputed facts and evidence gaps issue by issue, builds a chronology of the decision and any prior correspondence, and drafts a structured response that references your specific facts. You review and approve the exact letter before it's sent by certified mail with tracking and proof of delivery.",
    ctaText: "Start your administrative appeal",
    faqs: [
      { question: "How long do I have to appeal an administrative decision?", answer: "It depends entirely on the agency and jurisdiction — some administrative bodies allow as few as 10 to 15 days from the decision date, others allow 30 to 60 days. The deadline should be stated on your decision notice; if it isn't, confirm it in writing with the agency rather than assuming a general rule." },
      { question: "What does it mean to 'exhaust administrative remedies'?", answer: "Most agencies require you to complete every available internal review or appeal step before a court will hear your case — this is called exhausting administrative remedies. Skipping an internal appeal step can get a later court challenge dismissed, so it's important to confirm exactly which internal steps apply before escalating further." },
      { question: "What's the difference between an administrative appeal and going to court?", answer: "An administrative appeal asks the agency (or an internal review body within it) to reconsider its own decision. If that doesn't resolve the matter, many jurisdictions allow a further appeal — often called judicial review — to a state or federal court, but usually only after the internal administrative process is complete." },
      { question: "Do I need a lawyer to appeal an administrative decision?", answer: "Not necessarily for an internal agency appeal — many people prepare and file these themselves. For a subsequent court appeal (judicial review), or for a decision with serious financial or licensing consequences, consulting an attorney is worth considering. Appeal Mail helps you organize and draft the internal appeal; it does not provide legal representation." },
      { question: "What happens if I miss the appeal deadline?", answer: "In most cases, missing the deadline forfeits your right to that level of appeal, and you may have to accept the decision or start over with a new application where possible. Some agencies allow a late filing only for a specific, documented reason (illness, non-receipt of the notice). Certified mail with proof of delivery is the best way to document that you filed on time." },
      { question: "Can I appeal a decision from any government agency with this workflow?", answer: "This workflow is built for general administrative and agency decisions — licensing, permits, regulatory penalties, and similar rulings. If your decision is a health insurance denial, an SSI/SSDI determination, an unemployment decision, or a financial aid decision, Appeal Mail has a dedicated workflow for that specific type that asks more targeted questions." },
    ],
    relatedWorkflowIds: ["government-decision", "reconsideration", "license-suspension-appeal"],
  },
};

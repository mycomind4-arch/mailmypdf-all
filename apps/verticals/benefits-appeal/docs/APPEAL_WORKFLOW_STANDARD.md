# Benefits Appeal Workflow Standard v2

Effective: 2026-08-20
Catalog version: `2026-08-20-benefits-appeal-v2`
Current workflows: 32

## Customer experience

Every Benefits Appeal workflow uses one simple customer journey:
...
Current live provider for Benefits Appeal is Gemini. Claude/OpenAI can be added later through the MailMyPDF admin control plane without changing the customer workflow.
...
Do not create a new UI architecture for a new Benefits Appeal workflow. Add a new problem definition to `src/domain/workflows.ts`, give it its own keyword/problem metadata and AI prompt, and route it through the universal workspace and shared execution controls.

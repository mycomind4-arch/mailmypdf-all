# Benefits Appeal — Product Design Direction

## Role in the MailMyPDF family

Benefits Appeal is the specialized decision-to-appeal product. MailMyPDF is the fulfillment layer.
...
Benefits Appeal should feel like a finished specialized MailMyPDF product while remaining honest about which workflows are actually executable.

...
export const ECOSYSTEM_PRODUCTS: EcosystemProduct[] = [
  ...
  { name: "Benefits Appeal", slug: "benefits-appeal", href: "https://benefits-appeal.pages.dev", description: "Appeals, reconsiderations, denials, and adverse decisions", category: "Appeals / Claims", status: "live" },

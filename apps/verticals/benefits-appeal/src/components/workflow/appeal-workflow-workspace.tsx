    ...
    <main className="min-h-screen bg-paper px-6 py-10">
      <div className="mx-auto max-w-5xl">
        ...
        {stage === "build" && analysis && <section className="rounded-2xl border border-rule bg-paper-deep p-8">
          <div className="flex items-center gap-3"><div className="flex h-10 w-10 items-center justify-center rounded-full border border-rule bg-paper"><Sparkles size={18} /></div><div><h2 className="font-serif text-2xl">Here's what we found</h2><p className="text-sm text-muted-foreground">Our secure AI provider analyzed the source document for this specific workflow.</p></div></div>
        ...
        {stage === "send" && <section className="rounded-2xl border border-rule bg-paper-deep p-8">
          <div className="flex items-center gap-3"><div className="flex h-10 w-10 items-center justify-center rounded-full border border-rule bg-paper"><CheckCircle2 size={18} /></div><div><h2 className="font-serif text-2xl">Your response is ready for review</h2><p className="text-sm text-muted-foreground">The secure AI service drafted and independently checked the response. Nothing is mailed without your explicit approval.</p></div></div>

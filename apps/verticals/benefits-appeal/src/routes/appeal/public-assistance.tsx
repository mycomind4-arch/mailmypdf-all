...
const category = categoryMap["public-assistance"];
const entries = APPEAL_CATALOG.filter((e) => e.category === category);

export const Route = createFileRoute("/appeal/public-assistance")({
  head: () => ({
    meta: [
      { title: "Public Assistance Appeals | Benefits Appeal" },
      { name: "description", content: "SNAP/food stamps, housing benefits, and general public assistance denials and appeals." },
      { name: "robots", content: "index,follow" },
      { property: "og:title", content: "Public Assistance Appeals | Benefits Appeal" },
      { property: "og:description", content: "SNAP/food stamps, housing benefits, and general public assistance denials and appeals." },
  ...
  component: () => (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <h1 className="mt-3 font-serif text-4xl">Public Assistance Appeals</h1>
        <p className="mt-4 max-w-2xl text-lg text-muted-foreground">SNAP/food stamps, housing benefits, and general public assistance denials and appeals.</p>

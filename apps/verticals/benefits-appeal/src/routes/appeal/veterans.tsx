...
const category = categoryMap["veterans"];
const entries = APPEAL_CATALOG.filter((e) => e.category === category);

export const Route = createFileRoute("/appeal/veterans")({
  head: () => ({
    meta: [
      { title: "Veterans Benefits Appeals | Benefits Appeal" },
      { name: "description", content: "VA benefits denials, service connection disputes, rating decisions, and Board appeals." },
      { name: "robots", content: "index,follow" },
      { property: "og:title", content: "Veterans Benefits Appeals | Benefits Appeal" },
      { property: "og:description", content: "VA benefits denials, service connection disputes, rating decisions, and Board appeals." },
  ...
  component: () => (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <h1 className="mt-3 font-serif text-4xl">Veterans Benefits Appeals</h1>
        <p className="mt-4 max-w-2xl text-lg text-muted-foreground">VA benefits denials, service connection disputes, rating decisions, and Board appeals.</p>

...
const NEXT_ACTION_COPY: Record<string, { title: string; description: string }> = {
  intake: { title: "Add key documents", description: "Upload your contract, invoices, photos, and communications to strengthen your notice." },
  ...
  evidence: { title: "Finalize issue-by-issue support", description: "Review your evidence links and summaries to make sure each issue is clearly supported before moving to the timeline." },
  timeline: { title: "Finalize chronology", description: "Review your key dates and event sequencing to make sure the notice tells a clear, complete story." },
  draft: { title: "Review the draft notice", description: "Read through your draft carefully and make any needed edits before proceeding to the review step." },
  review: { title: "Approve the final package", description: "Review the complete notice package and confirm mailing settings before sending." },
...
function MatterStepPage() {
  ...
  return (
    <>
      <MatterAppHeader />
      <StepShell
      breadcrumb={[{ label: "My Matters", href: "/dashboard" }, { label: definition.title }]}

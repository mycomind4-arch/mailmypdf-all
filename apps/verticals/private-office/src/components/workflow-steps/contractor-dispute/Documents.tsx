...
const RECOMMENDED_CATEGORIES = ["Contract", "Invoices", "Photos", "Messages", "Inspection Reports", "Estimates", "Permits"];
  ...
  return (
    <>
      <SectionCard
        ...
        description="Upload and organize all relevant documents related to your contractor dispute. These records will be used to support your notice and included in your mailing package as exhibits."
      ...
      >
        <Dropzone
          onFiles={handleFiles}
          hint="Supported formats: PDF, JPG, PNG, DOC, DOCX, XLS, XLSX (max 25 MB each)"
        />
      ...
      <RecommendedStepsRow
        steps={[{ label: "Upload missing evidence" }, { label: "Categorize files" }, { label: "Continue to Analyze" }]}

...
export async function GET() {
  ...
  const allProviders = [
    { id: 'gemini', label: 'Google Gemini', description: 'Fallback and independent review', available: available.includes('gemini'), model: getDefaultModel('gemini') },
  ...
  return NextResponse.json({ providers: allProviders, default: 'claude' })
}

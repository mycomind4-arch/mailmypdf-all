...
/**
 * Immigration Mail's step-matter persistence: the generic Supabase
 * repository from @mailmypdf/step-workflow, pointed at this app's own
 * immigration_mail_step_matters/_step_events tables (see
 * supabase/migrations for the schema).
 */
export const supabaseStepMatterRepository = new SupabaseStepMatterRepository({
  ...config(),
  tablePrefix: "immigration_mail",
});

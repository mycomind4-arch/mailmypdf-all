 ...
 * identical contract to Private Office's, so any future workflow (in any
 * app) plugs into the shared route/rail/state machinery with only new step
 * components, no route changes.
 */

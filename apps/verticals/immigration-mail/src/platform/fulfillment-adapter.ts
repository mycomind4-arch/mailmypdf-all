 ...
 *
 * Keeps Immigration Mail's persistence/schema translation local while all
 * payment->approval->fulfillment correctness lives in the shared platform.
 */
import { createClient } from "@supabase/supabase-js";
import {
  createMailingClient as createSharedMailingClient,
...
export function createMailMyPDFClient(): MailMyPDFClient {
  const client = createSharedMailingClient("immigration-mail");
  return {

...
const NEXT_ACTION_COPY: Record<string, { title: string; description: string }> = {
  intake: { title: "Add supporting documents", description: "Upload your NOID notice and any evidence that supports your response." },
  ...
  evidence: { title: "Finalize ground-by-ground responses", description: "Review your evidence and responses to make sure each denial ground is clearly addressed before moving to the timeline." },
  timeline: { title: "Finalize chronology", description: "Review your key dates to make sure your response timeline is accurate and the deadline is confirmed." },
  ...
  mail: { title: "Send the mailing package", description: "Finish the workflow by purchasing postage and sending your certified mailing package to USCIS." },

...
// workflowStepUiRegistry, so this must not name a specific agency, notice
// type, or recipient. A prior conversion (Appeal Mail) found this exact copy
// block hardcoded to a different app's notice type ("Upload your NOID
// notice...", "...to USCIS") after being copied without adjustment — keep
// every entry here free of any workflow-specific noun.
const NEXT_ACTION_COPY: Record<string, { title: string; description: string }> = {
  identify: { title: "Confirm what this notice is", description: "Review the notice type we detected and confirm the deadline and details before continuing." },
  intake: { title: "Add supporting documents", description: "Upload the documents that support your matter." },
  strategy: { title: "Choose your response path", description: "Review the options available for this matter and pick the one that matches what you want to happen." },
  documents: { title: "Confirm analysis", description: "Review the analysis above and make any needed corrections. Once confirmed, continue to drafting." },
  analyze: { title: "Confirm analysis", description: "Review the analysis above and make any needed corrections. Once confirmed, continue to drafting." },
  evidence: { title: "Finalize your responses", description: "Review your evidence and responses to make sure each item is clearly addressed before moving on." },
  timeline: { title: "Finalize chronology", description: "Review your key dates to make sure your timeline is accurate and any deadline is confirmed." },
  draft: { title: "Review the draft", description: "Read through your draft carefully and make any needed edits before proceeding to the review step." },
  review: { title: "Approve the final package", description: "Review the complete package and confirm mailing settings before sending." },
  mail: { title: "Send the mailing package", description: "Finish the workflow by purchasing postage and sending your certified mailing package." },
...
function MatterStepPage() {
  ...
  // "overview" isn't one of the stepper's steps — highlight nothing there,

...
import { analyzeDisputedItems, type EquifaxDisputeIntake } from "@/domain/step-workflows/equifax-dispute";
  ...
  return (
    <>
      <SectionCard
        ...
        description="We reviewed each disputed item against what an Equifax reinvestigation actually needs for its category. Review the findings below and go back to Intake or Documents to close any gaps."
      ...
      <SectionCard title="Your FCRA rights and the investigation timeline" description="These apply automatically once Equifax receives your dispute — the letter you draft next will reference them.">
        <ul style={{ display: "flex", flexDirection: "column", gap: "0.6rem", fontSize: "0.85rem", color: "var(--wf-color-stone)" }}>
          <li><strong style={{ color: "var(--wf-color-ink, inherit)" }}>30 days to investigate</strong> — Equifax must reinvestigate each disputed item within 30 days of receiving your letter (45 days if you send more information during that window), under FCRA Section 611(a).</li>
          <li><strong style={{ color: "var(--wf-color-ink, inherit)" }}>Correction and notice</strong> — if an item can't be verified as accurate, Equifax must delete or correct it, send you a free updated report, and notify the furnisher, under Section 611(a)(6) and 611(d).</li>
          <li><strong style={{ color: "var(--wf-color-ink, inherit)" }}>Recipients notified</strong> — you can ask Equifax to send corrected reports to anyone who received your report in the past 6 months (2 years for employment purposes), under Section 611(d).</li>
          <li><strong style={{ color: "var(--wf-color-ink, inherit)" }}>If Equifax disagrees</strong> — you can request the method of verification within 15 days, and if you still disagree, add a personal statement of dispute (up to 100 words) to your file, under Section 611(a)(7) and 611(b)-(c).</li>
        </ul>
      </SectionCard>

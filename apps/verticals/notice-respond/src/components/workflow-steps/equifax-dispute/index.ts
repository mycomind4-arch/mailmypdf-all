 ...
 * workflow — see the comment on `equifaxDisputeStepWorkflow` in
 * `domain/step-workflows/equifax-dispute.ts` for why.
 */
export const equifaxDisputeStepComponents: Record<string, ComponentType<StepComponentProps>> = {

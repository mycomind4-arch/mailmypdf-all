...
import type { TransUnionDisputeIntake } from "@/domain/step-workflows/transunion-dispute";

const PACKAGE_ITEMS = [
  { title: "Final dispute letter", meta: "1–2 pages", description: "Completed FCRA dispute letter addressed to TransUnion's Consumer Dispute Center." },
  ...
  { title: "Mailing proof sheet", meta: "1 page", description: "Coversheet with the TransUnion address and certified mail details." },
];
...
export function ReviewStep({ matter, onApprove, onComplete }: StepComponentProps) {
  ...
  return (
    <>
      <SectionCard
        title="Final review"
        description="This is your last chance to confirm the letter, exhibits, and mailing instructions before it's sent to TransUnion."

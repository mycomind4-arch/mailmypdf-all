  ...
  return (
    <>
      <SectionCard
        ...
        description="Upload your TransUnion credit report first — it's what confirms the report date and the items you're disputing. Then add proof of identity and anything that supports your disputed items (statements, payment records, a police report for identity theft)."
      ...
      >
        ...
        {!hasReport && files.length > 0 && (
          <p style={{ marginTop: "0.75rem", fontSize: "0.8rem", color: "var(--wf-color-warning, #b45309)" }}>
            We don't see a credit report among your uploads yet — rename or tag one as "TransUnion Credit Report" so it's clearly identified in your mailing package.
          </p>
        )}

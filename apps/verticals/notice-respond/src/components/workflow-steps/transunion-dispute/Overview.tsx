...
export function OverviewStep({ matter, goToStep }: StepComponentProps) {
  ...
  return (
    <SectionCard title="Matter overview" description="A summary of this TransUnion Dispute matter and quick links to each step.">
      ...
      <ul style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
        {transunionDisputeStepWorkflow.steps.map((step, index) => {
